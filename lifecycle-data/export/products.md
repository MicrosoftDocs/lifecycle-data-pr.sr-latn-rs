...
ms.locfileid: "887833"
---
# <a name="export"></a><span data-ttu-id="1cf1c-103">Zno</span><span class="sxs-lookup"><span data-stu-id="1cf1c-103">Export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="1cf1c-104">Ova stranica je u razvoju.</span><span class="sxs-lookup"><span data-stu-id="1cf1c-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="1cf1c-105">Izvoz svih proizvoda</span><span class="sxs-lookup"><span data-stu-id="1cf1c-105">Export All Products</span></span>
<span data-ttu-id="1cf1c-106">Izvoz svih proizvoda bez filtera.</span><span class="sxs-lookup"><span data-stu-id="1cf1c-106">Export all products without any filters.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="1cf1c-107">Izvoz svih proizvoda</span><span class="sxs-lookup"><span data-stu-id="1cf1c-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-category"></a><span data-ttu-id="1cf1c-108">Izvoz proizvoda po kategoriji</span><span class="sxs-lookup"><span data-stu-id="1cf1c-108">Export Products by Category</span></span>
<span data-ttu-id="1cf1c-109">Izaberite grupisanje za izvoz:</span><span class="sxs-lookup"><span data-stu-id="1cf1c-109">Select a grouping to export:</span></span>
...
## <a name="export-products-by-end-of-support-year"></a><span data-ttu-id="1cf1c-167">Izvoz proizvoda po okončanju godine</span><span class="sxs-lookup"><span data-stu-id="1cf1c-167">Export Products by End of Support Year</span></span>
<span data-ttu-id="1cf1c-168">Izaberite godinu za završetak usluge izvoza proizvoda te godine:</span><span class="sxs-lookup"><span data-stu-id="1cf1c-168">Select a year to export products ending service in that year:</span></span>
