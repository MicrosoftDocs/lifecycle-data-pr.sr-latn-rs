...
ms.locfileid: "902650"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="95cf9-103">Izvoz podataka životnog ciklusa</span><span class="sxs-lookup"><span data-stu-id="95cf9-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="95cf9-104">Ova stranica je u razvoju.</span><span class="sxs-lookup"><span data-stu-id="95cf9-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="95cf9-105">Izvoz svih proizvoda</span><span class="sxs-lookup"><span data-stu-id="95cf9-105">Export all products</span></span>
<span data-ttu-id="95cf9-106">Izvezite podatke životnog ciklusa za sve proizvode tako što ćete kliknuti ispod:</span><span class="sxs-lookup"><span data-stu-id="95cf9-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="95cf9-107">Izvoz svih proizvoda</span><span class="sxs-lookup"><span data-stu-id="95cf9-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="95cf9-108">Izvoz proizvoda po porodici i grupi</span><span class="sxs-lookup"><span data-stu-id="95cf9-108">Export products by Family and Group</span></span>
<span data-ttu-id="95cf9-109">Izaberite porodicu, a zatim grupu za izvoz.</span><span class="sxs-lookup"><span data-stu-id="95cf9-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="95cf9-110">Napomena: izvoz će početi kada je izabrana vrednost grupe.</span><span class="sxs-lookup"><span data-stu-id="95cf9-110">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="95cf9-168">Izvoz proizvoda po datumu podrške</span><span class="sxs-lookup"><span data-stu-id="95cf9-168">Export products by end of support date</span></span>
<span data-ttu-id="95cf9-169">Izaberite godinu da biste videli proizvode koji su dostigli kraj podrške.</span><span class="sxs-lookup"><span data-stu-id="95cf9-169">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="95cf9-170">Napomena: izvoz će početi kada je izabrana vrednost godina.</span><span class="sxs-lookup"><span data-stu-id="95cf9-170">Note: Export will begin when Year value is selected.</span></span>
